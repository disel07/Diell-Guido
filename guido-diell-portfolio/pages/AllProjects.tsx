        ...
        <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <div className="h-1 w-32 bg-cyber-primary mx-auto rounded-full shadow-[0_0_15px_#00f3ff]" />
                        ...
                        >
                            ...
                            <div className="p-8 flex flex-col h-full">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center justify-center w-full py-4 bg-white/5 hover:bg-cyber-primary hover:text-black text-white rounded-lg transition-all duration-300 font-mono font-bold tracking-wide"
                                >
                                    VIEW PROJECT
                                </a>
                            </div>
