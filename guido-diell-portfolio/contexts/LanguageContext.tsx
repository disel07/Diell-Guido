...
export const dictionary = {
  en: {
    ...
    hero: {
      ...
      role: 'IT Student | Python · Linux · Docker · Bash · SQL',
      description: 'Looking for cybersecurity or blockchain opportunities in IT, hybrid or remote environments.',
      cards: [
    ...
    skills: {
      ...
      about:
        'I am an IT student based in Calabria, focused on Python, Linux, Docker, Bash and SQL. I am building a practical path toward cybersecurity and blockchain through school projects, internships and verified certifications.',
    ...
    learning: {
      ...
      titleB: 'LEARNING',
      badge: 'LIVE ROADMAP',
      subtitle: 'A realistic roadmap toward cybersecurity, blockchain and practical IT work.',
    ...
    education: {
      titleA: 'EDUCATION',
      titleB: 'PATH',
      subtitle: 'Formal training and technical direction.',
  ...
  it: {
    ...
    hero: {
      ...
      role: 'Studente IT | Python · Linux · Docker · Bash · SQL',
      description: 'Cerco opportunita in cybersecurity o blockchain in ambito IT, ibrido o da remoto.',
      cards: [
    ...
    skills: {
      ...
      about:
        'Sono uno studente IT in Calabria, concentrato su Python, Linux, Docker, Bash e SQL. Sto costruendo un percorso pratico verso cybersecurity e blockchain tramite scuola, stage e certificazioni verificate.',
    ...
    learning: {
      ...
      subtitle: 'Una roadmap realistica verso cybersecurity, blockchain e lavoro IT pratico.',
    ...
    education: {
      titleA: 'PERCORSO',
      titleB: 'FORMATIVO',
      subtitle: 'Formazione scolastica e direzione tecnica.',
      label: 'Timeline formazione',
      focus: 'Aree di focus',
    },
    contact: {
      titleA: 'PROTOCOLLO',
